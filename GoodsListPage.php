...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1>Страница сувениров</h1>
            <p class="lead fs-4 mb-4">Памятные подарки для себя и близких.</p>
        </div>
    </section>
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <div class="col-md-3">
                            <div class="card service-card">
                                ...
                                <div class="card-body">
                                    <h5><?php echo htmlspecialchars($row['Name']); ?></h5>
                                    <p class="small text-muted"><?php echo htmlspecialchars($row['ShortDescription']); ?></p>
                                    <a href="GoodsSamplePage.php?id=<?php echo $row['ID']; ?>" 
